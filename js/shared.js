...
<header class="site-header">
  ...
  <nav class="primary-nav" id="primaryNav">
    <div class="container">
      <ul class="nav-list">
        <li class="nav-item">
          <a href="${base}discovery/plp.html" class="nav-link">Simulation <span class="nav-arrow">▾</span></a>
          <div class="nav-dropdown">
            <a href="${base}discovery/plp.html" class="dropdown-link">Advanced Life Support (ALS)</a>
            <a href="${base}discovery/plp.html" class="dropdown-link">Airway Management</a>
            <a href="${base}discovery/plp.html" class="dropdown-link">CPR &amp; Basic Life Support</a>
            <a href="${base}discovery/plp.html" class="dropdown-link">Obstetrics &amp; Gynaecology</a>
            <a href="${base}discovery/plp.html" class="dropdown-link">Surgical Simulation</a>
            <a href="${base}discovery/plp.html" class="dropdown-link">Ultrasound</a>
            <a href="${base}discovery/plp.html" class="dropdown-link">View All Simulation →</a>
          </div>
        </li>
        <li class="nav-item">
          <a href="${base}discovery/plp.html" class="nav-link">Anatomy Models <span class="nav-arrow">▾</span></a>
          <div class="nav-dropdown">
            <a href="${base}discovery/plp.html" class="dropdown-link">Human Anatomy Models</a>
            <a href="${base}discovery/plp.html" class="dropdown-link">Skeleton Models</a>
            <a href="${base}discovery/plp.html" class="dropdown-link">Heart &amp; Organ Models</a>
            <a href="${base}discovery/plp.html" class="dropdown-link">Microanatomy Models</a>
            <a href="${base}discovery/plp.html" class="dropdown-link">Synthetic Cadaver Models</a>
          </div>
        </li>
        <li class="nav-item">
          <a href="${base}discovery/plp.html" class="nav-link">Health Education <span class="nav-arrow">▾</span></a>
          <div class="nav-dropdown">
            <a href="${base}discovery/plp.html" class="dropdown-link">Drug, Alcohol &amp; Smoking</a>
            <a href="${base}discovery/plp.html" class="dropdown-link">Sex Education</a>
            <a href="${base}discovery/plp.html" class="dropdown-link">Childbirth &amp; Development</a>
            <a href="${base}discovery/plp.html" class="dropdown-link">Men's Health</a>
            <a href="${base}discovery/plp.html" class="dropdown-link">Procedure Training</a>
          </div>
        </li>
        <li class="nav-item">
